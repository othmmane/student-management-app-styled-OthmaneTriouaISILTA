...
<div class="card">
    ...
    <form action="${pageContext.request.contextPath}/students/add" method="post">
        <div class="form-group">
            ...
            <input type="text" name="firstName" placeholder="e.g. Othman" required>
        </div>
        <div class="form-group">
            <label>👤 Last Name</label>
            <input type="text" name="lastName" placeholder="e.g. Trioua" required>
        </div>
        <div class="form-group">
            <label>📧 Email</label>
            <input type="email" name="email" placeholder="e.g. othman@example.com" required>
        </div>
        <div class="btn-row">
